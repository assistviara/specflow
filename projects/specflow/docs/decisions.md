...
## DEC-001 Document Loader

- 対象：Document Loader
- 判定：APPROVED
- 正本文書：`decision_document_loader.md`

---

## DEC-002 Template Engine
...
## DEC-006 UC-05 Codex Implementation Prompt Generation
